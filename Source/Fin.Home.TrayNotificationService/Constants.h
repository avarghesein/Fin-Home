...
#define UM_FINANCE WM_USER + 201
	...
	#define UP_MEDIA_INSERT			  4
	#define UP_MEDIA_EJECT			  5
...
#define CONST_ALERT_CHECK_COUNT   2
#define CONST_BKUP_INTERVAL_DAYS  25
#define CONST_STARTUP_TIMER_NONEED_HOURS 5
...
#define FINANCE_UNIQUE_OBJECT_NAME _T("A2B2539B-AE97-4279-8693-FBAD0DA7A7C6")
...
public:
	...
	CString BackupPath;
	bool BackupStatus;
	CTime LastBackupDate;
};

struct SGlobalObjects
{
public:
	HWND m_hMainWnd;
};
...
extern SGlobalObjects _globalObjects;
