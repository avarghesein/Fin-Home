...
BOOL CFinWindow::Create(CWnd*& mainWind, bool serviceMode)
{
	if( 0 != m_hWnd )
	{
		return TRUE;
	...
	HWND hWnd  = ::FindWindow(pstrOwnerClass, FINANCE_UNIQUE_WINDOW_NAME);	
	...
	BOOL ret = CreateEx( 0, pstrOwnerClass, FINANCE_UNIQUE_WINDOW_NAME, WS_POPUP, CW_USEDEFAULT,
								   CW_USEDEFAULT,
								   CW_USEDEFAULT,
								   CW_USEDEFAULT,
								   NULL, 0 );
